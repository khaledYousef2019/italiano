<nav class="main_navigation <?= (isset($_COOKIE['menu_opened']) && $_COOKIE['menu_opened'] == 'true') ? 'opened no_animation' : '' ?>">
    <div class="employee_info">
        ...
        <span class="name"><?php // $this->session->u->profile->FirstName ?> <?php // $this->session->u->profile->LastName ?></span>
        <span class="privilege"><?php // $this->session->u->GroupName ?></span>
    </div>
    <ul class="app_navigation">
        <li class="<?php // $this->matchUrl('/') === true ? ' selected' : '' ?>"><a href="/"><i class="fa fa-dashboard"></i> <?= $text_general_statistics ?></a></li>
        <li class="submenu">
        ...
        <li class="<?php // $this->matchUrl('/suppliers') === true ? ' selected' : '' ?>"><a href="/suppliers"><i class="material-icons">group</i> <?= $text_suppliers ?></a></li>
        <li class="submenu">

<header class="main">
    <a href="javascript:;" data-menu-status="<?php // (isset($_COOKIE['menu_opened']) && $_COOKIE['menu_opened'] == 'true') ? 'true' : 'false' ?>" class="menu_switch <?= (isset($_COOKIE['menu_opened']) && $_COOKIE['menu_opened'] == 'true') ? 'opened no_animation' : '' ?>"><i class="fa fa-bars"></i></a>
    <h1><?= $text_dashboard ?>
        <?php if (isset($title)): ?>
            <?= ' > ' . $title ?>
        <?php endif; ?>
    ...
    <div class="user_menu_container">
        <a href="javascript:;" class="language_switch user">
            <span><?= $text_welcome ?> <?php // $this->session->u->Username ?></span>
    ...
    <a href="/language" class="language_switch"><span><?php $_SESSION['lang'] == 'ar' ? 'En' : 'ar' ?></span> <i class="fa fa-globe"></i></a>
</header>